package com.nomisapplication.app.modules.frametwelve.`data`.model
...
data class FrameTwelveModel(
   ...
   */
  var txtUpdateBook: String? = MyApp.getInstance().resources.getString(R.string.lbl_update_book)
  ,
  /**
   * TODO Replace with dynamic value
   */
   ...
   * TODO Replace with dynamic value
   */
  var txtLanguageTwo: String? = MyApp.getInstance().resources.getString(R.string.lbl_update2)
